      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch">
        ...
        >
          ...
          <p className="text-secondary text-base sm:text-lg md:text-xl text-center lg:text-left w-full">
            Elevate your recipes with Joya Foods' creamy coconut milk. Perfect for curries, smoothies, and desserts, our coconut milk delivers unparalleled richness and flavor to your recipes.
          </p>
        </motion.div>
